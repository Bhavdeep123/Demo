...
export default function Contact({ isActive }) {
  ...
  const filteredData1 = DummyData1.filter((user) =>
    user.name.toLowerCase().includes(searchQuery1.toLowerCase())
  );
                  ...
                  return (
                    <Box className="backbox" display={"flex"}>
                      ...
                      <Box width={"220px"}>
                        ...
                        <img src={call_icon} className="smallcallicon"></img>
                        <span
